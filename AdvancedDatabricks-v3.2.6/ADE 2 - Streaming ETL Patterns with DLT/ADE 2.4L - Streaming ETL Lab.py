...
display(spark.sql("select * from workouts_silver order by user_id, time"))
...
spark.sql("DROP SCHEMA IF EXISTS hive_metastore.b_benltaief_losk_da_adewd_streaming_etl_lookup CASCADE")
